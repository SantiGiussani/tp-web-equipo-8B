...
<div class="row g-3 needs-validation">
  ...
  <label for="validationCustom01" class="form-label">DNI:</label>
   <asp:TextBox runat="server" CssClass="form-control" type="text" ID="txtboxDNI"/>
    </div>
  ...
  <div class="col-md-1">
    <label for="validationCustom05" class="col-form-label-sm"> Codigo postal: </label>
      <asp:TextBox runat="server" CssClass="form-control" type="text" ID="txtboxCP" TextMode="Number"/>
  </div>    
  ...
  <div class="col-12">
      <asp:Button Text="Registrarse" CssClass="btn btn-primary" runat="server" OnClick="Click" />
  </div>
    <div class="text-danger-emphasis">
    <asp:Label Text="Por favor, complete todos los campos" runat="server" Visible="false" id="Incompleto"/>
    </div>  
</div>
